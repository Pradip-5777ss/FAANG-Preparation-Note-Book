 ...
 *         L2 = 2->4->6->8
 *  Output: 2 4 6
 *  Explanation: For the given first two linked list, 2, 4 and 6 are the elements
 *  in the intersection.
 * 
...
public class Q07_IntersectionOfTwoSortedLL {
    ...
    static Q07_IntersectionOfTwoSortedLL iOfTwoSortedLL = new Q07_IntersectionOfTwoSortedLL();
     ...
     * @param head1
     * @param head2
     * @return the common elements between two list
     */
