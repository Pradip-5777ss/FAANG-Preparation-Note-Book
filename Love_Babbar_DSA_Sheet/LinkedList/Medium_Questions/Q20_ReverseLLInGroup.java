 ...
 * Write a program to reverse a linked list in group of given size. Given a
 * linked list of size N. The task is to reverse every k nodes (where k is an
 * input to thefunction) in the linked list. If the number of nodes is not a
 * multiple of k then left-out nodes, in the end, should be considered as a
 * group and must be reversed.
 * 
 * Example 1:
 *  Input : LinkedList: 1->2->2->4->5->6->7->8
 *          K = 4
 *  Output: 4 2 2 1 8 7 6 5
 *  Explanation: The first 4 elements 1,2,2,4 are reversed first and then the
 *  next 4 elements 5,6,7,8. Hence, the resultant linked list is
 *  4->2->2->1->8->7->6->5.
 * 
 * Example 2:
 ...
 *          K = 3
 *  Output: 3 2 1 5 4
 *  Explanation: The first 3 elements are 1,2,3 are reversed first and then
 *  elements 4,5 are reversed.Hence, the resultant linked list is 3->2->1->5->4.
 * 
 * Time Complexity : O(N)
 * Space Complexity : O(1)
 */
package Love_Babbar_DSA_Sheet.LinkedList.Medium_Questions;

import java.util.Scanner;

public class Q20_ReverseLLInGroup {
    ...
    public static void main(String[] args) {
        ...
        Q20_ReverseLLInGroup rInGroup = new Q20_ReverseLLInGroup();
     ...
     * 
     * @param node as headnode
     * @param k as the size of group
     * @return
     */
