 ...
 * Write a program to find the starting point of the loop in Linked list. Given
 * a linked list of N nodes. The task is to check if the linked list has a loop
 * then find the first node of loop in the Linked List.
 * 
 * Example:
 *  Input : N = 3
 *          value[] = {1,3,4}
 ...
 *  given. Then value of x=2 is given which means last node is connected with 
 *  xth node of linked list. Therefore, the first node of the list is 3.
 * 
 * Time Complexity : O(N)
...
public class Q22_FindFirstNodeOfLoopInLL {
    ...
    public static void main(String[] args) {
        ...
        Q22_FindFirstNodeOfLoopInLL fFirstNode = new Q22_FindFirstNodeOfLoopInLL();
