...
public class Q26_CountTriplesInSortedDLL {
    ...
    public static void main(String[] args) {
        ...
        Q26_CountTriplesInSortedDLL countTriplets = new Q26_CountTriplesInSortedDLL();
     ...
     * @param head
     * @param val
     * @return the count of the triplets
     */
     ...
     * @param second
     * @param val
     * @return the count of the triplets pair
     */
