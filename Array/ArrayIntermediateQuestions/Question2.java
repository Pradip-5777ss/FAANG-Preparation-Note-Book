...
public class Question2 {
	...
	public static void main(String[] args) {
		...
		//ask user to enter all the array elements according to the size. iterate for loop to take the user input
	...
	static void cyclicallyRotate(int arr[], int size)
	{
		...
		for (int i = size - 1; i > 0 ; i--) {
			//"arr[i-1]" value is stored in arr[i].[i.e suppose the size of the array is 6. then arr[4] value is store into arr[5]
			arr[i] = arr[i-1];
		}
