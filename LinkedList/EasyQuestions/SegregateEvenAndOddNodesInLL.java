 ...
 * Given a link list of size N, modify the list such that all the even numbers appear before 
 * all the odd numbers in the modified list. The order of appearance of numbers within each 
 ...
 * Explaination: 8,2,4,6 are the even numbers so they appear first and 17,15,9 are odd so they
 * appear after the even number.
 * 
 * Time Complexity : O(N)
