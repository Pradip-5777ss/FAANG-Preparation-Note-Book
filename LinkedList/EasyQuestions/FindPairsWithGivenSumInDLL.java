/**
 * Write a program to Find pairs with a given sum in a Doubly Linked List. Given a sorted
 * doubly linked list of positive distinct elements, the task is to find pairs in a 
...
public class FindPairsWithGivenSumInDLL {
    ...
    public static void main(String[] args) {
        ...
        FindPairsWithGivenSumInDLL fPairSumInDLL = new FindPairsWithGivenSumInDLL();
